...
function onia_scripts()
{
	...
	wp_enqueue_style('onia-main-style', get_template_directory_uri() . '/assets/css/main.css', array(), ONIA_VERSION);
	...
	wp_enqueue_script('onia-scripts', get_template_directory_uri() . '/assets/js/scripts.js', array('jquery'), ONIA_VERSION, true);
